  ...
  return (
    <animated.div
      style={{
        ...
        width: '100%',
        maxWidth: '400px',
        height: '100%', // Usar toda la altura disponible del contenedor
        maxHeight: '100%', // Sin límite máximo, usar todo el espacio
        minHeight: '100%', // Asegurar que use toda la altura disponible
        margin: '0 auto',
        position: 'relative',
      ...
      <div className="p-8 h-full flex flex-col overflow-hidden">
        ...
        <div className="flex-shrink-0">
          ...
          <div className="text-center mb-3">
            <h2 className={`text-2xl font-bold leading-tight ${isDisabled ? 'text-gray-500' : 'text-gray-900'}`}>
        ...
        <div className="flex-1 space-y-5 min-h-0">
          <div className={`flex items-center space-x-3 ${isDisabled ? 'text-gray-400' : 'text-gray-700'}`}>
            ...
            <a
              ...
              className={`text-lg hover:underline ${isDisabled ? 'text-gray-400 pointer-events-none' : 'text-blue-600 hover:text-blue-800'}`}
          ...
          {appointment.comentarios && appointment.comentarios.length > 0 && (
            <div className="flex items-start space-x-3 text-gray-700 pt-3 border-t border-gray-200 mt-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium text-gray-800 mb-2">Comentarios de la cita:</div>
